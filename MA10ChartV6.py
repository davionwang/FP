# -*- coding: utf-8 -*-
"""
Created on Wed Sep 13 16:20:21 2023
...
#V1 use new database 1 column includes 2021 and 2022
#V2 add 2022 view for supply plant and IHS contract for all supply; re- read ihs contract for demand, and add supply
#V3 rename difference to 2022vsdesk2022
#V4 add 2 desk Demand charts
#v5 add Mozambique and Portovaya
#V6 regroup EUDESK and other eu, SP, IT PO
...
class FlowMA10Chart():
    ...
    def full_data():
        ...
        supplycountry=DBTOPD('PRD-DB-SQL-211','LNG', 'ana', 'SupplyCountry')
        dfsupplycountry=supplycountry.sql_to_df()
        dfsupplycountry.set_index('Date', inplace=True)
        
        supplyMA_eta=DBTOPD('PRD-DB-SQL-211','LNG', 'ana', 'SupplyCountryETA')
        ...
        dfihscontractdemand = dfihscontractdemand*0.8 #2023 IHS IS 100%
        #print(dfihscontractdemand )
        ...
        dfihscontractsupply = dfihscontractsupply*0.8 #2023 ihs IS 100%
        ...
        netdemand=DBTOPD('PRD-DB-SQL-211','LNG', 'ana', 'KplerNetDemandBasinMt') #mt
        dfnetdemand=netdemand.sql_to_df()
        dfnetdemand.rename(columns=({'index':'Date'}), inplace=True)
        dfnetdemand.set_index('Date', inplace=True)
        #print(dfnetdemand)
        
        
        
        
        return dfdemand, dfsupplyplant, dfsupplycountry, dfsupplyMA_eta, dfsupplyMA_eta_plant, dfdemandMA_eta, desk_supply_plant_view, desk_supply_country_view, desk_demand_view, dfihscontractdemand,dfihscontractsupply, supply_country_list, demand_country_list, dfbasinsupply,dfbasindemand,dfcumsupply,dfcumdemand,dfnetdemand
        ...
        if datetime.date.today().month-1==0:
            if sd == 'supply':
                ...
                fig1.update_layout(
                    ...
                    title_text=country + ' 10 days MA, Mcm/d '+ str(today),
                ...
                py.plot(fig1, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/all market/'+country+'.html', auto_open=False)
                fig1.write_image("U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/all market/'+country+'.png")
            if sd == 'demand':       
                fig1 = go.Figure() 
                ...
                py.plot(fig1, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/all market/'+country+'.html', auto_open=False) 
                fig1.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/all market/'+country+'.png')
        else:
    ...
    def country_chart(date_dict,supply_country_list, demand_country_list, dfsupplycountry, dfdemand, dfsupplyMA_eta, dfdemandMA_eta, desk_supply_country_view, desk_demand_view, dfihscontractdemand,dfihscontractsupply):    
        ...
        for i in supply_country_list:
            ...
            #print(supply_yoy)
            FlowMA10Chart.plot_chart(supply_yoy, 'supply', i, today)
        for j in demand_country_list:
            ...
            FlowMA10Chart.plot_chart(demand_yoy, 'demand', j, today)
    ...
    def global_chart(date_dict, supply_country_list, demand_country_list, dfsupplycountry, dfdemand, dfsupplyMA_eta, dfdemandMA_eta, desk_supply_country_view, desk_demand_view, dfihscontractdemand,dfihscontractsupply):
        ...
        FlowMA10Chart.plot_chart(supply_global_yoy, 'supply', 'Global', today)  
        ...
        FlowMA10Chart.plot_chart(demand_global_yoy, 'demand', 'Global', today)
    ...
    def Basin_Chart_supply(df_basin, date_dict):
        ...
        fig_Basin.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['MENA'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
        ...
        fig_Basin.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['PB'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
        ...
        fig_Basin.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['AB'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
        ...
        fig_Basin.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Basin Supply, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_MENA.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['Ras Laffan'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
        ...
        fig_MENA.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='MENA Supply, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_PB.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='PB Supply, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_AB.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='AB Supply, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_EoS.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['EoS'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
        ...
        fig_EoS.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='EoS, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Exports (Mcm/d)",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_WoS.add_trace(
                go.Scatter(
                    x=x_index,
                    y=df_basin['WoS'].loc[date_dict['current_year_start']:date_dict['today']],
                    mode="lines",
                    name='Kpler '+str(today.year),
                    showlegend=True,
                    line=dict(color='black', width=2, dash='solid')
        ...
        fig_WoS.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='WoS, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Exports (Mcm/d)",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        py.plot(fig_MENA, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/MENA Supply.html', auto_open=False)
        py.plot(fig_Basin, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/Basin Supply.html', auto_open=False)
        py.plot(fig_PB, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/PB Supply.html', auto_open=False)
        py.plot(fig_AB, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/AB Supply.html', auto_open=False)
        py.plot(fig_EoS, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/EoS Supply.html', auto_open=False)
        py.plot(fig_WoS, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/regional/WoS Supply.html', auto_open=False)
        
        fig_MENA.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/MENA Supply.png')
        fig_Basin.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/Basin Supply.png')
        fig_PB.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/PB Supply.png')
        fig_AB.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/AB Supply.png')
        fig_EoS.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/EoS Supply.png')
        fig_WoS.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/regional/WoS Supply.png')
    
    
    def Supply_Cumulative_Chart(df_cumulative, date_dict, SupplyCategories):
        
        today=datetime.date.today()
        last_month= str((datetime.date.today() - relativedelta(months=1)).year)+'-'+str((datetime.date.today() - relativedelta(months=1)).month)+'-01'
        ...
        for p in BasinSuez:
            ...
            for j in range(0, today.month -1 ):
                fig_Cumsum_Basin.add_annotation(x=bardate[j], y=5,
                        ...
                        #text=df_cumulative[p+' Cum Difference'].loc[bardate[j]].iloc[0],
                        showarrow=False)
            #print(Basin)    
            ...
            py.plot(fig_Cumsum_Basin, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/supply/BasinSuez/'+p+' Cum Supply.html', auto_open=False)    
            fig_Cumsum_Basin.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/supply/BasinSuez/'+p+' Cum Supply.png')
        ...
        for q in allplant:
            ...
            fig_Cumsum_Plant.add_annotation(x=x_index[-1], y=df_cumulative[q+' Cum'].loc[date_dict['last_year_month']],
                    ...
                    ay=30,
                    arrowhead=5)   
            fig_Cumsum_Plant.add_annotation(x=x_index[-1], y=df_cumulative[q+' Desk Cum'].loc[x_index[-1]],
                    text=str(df_cumulative[q+' Desk Cum'].loc[x_index[-1]]) + ' (Desk view '+str(today.year)+')',
                    showarrow=True,
                    arrowhead=5)
            ...
            for j in range(0, today.month -1 ):
                fig_Cumsum_Plant.add_annotation(x=bardate[j], y=df_cumulative[q+' Cum Difference'].loc[bardate].min()+0.5,
                        ...
                        #text=df_cumulative[q+' Cum Difference'].loc[bardate[j]].iloc[0],
                        showarrow=False)
            ...
            py.plot(fig_Cumsum_Plant, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/supply/all plant/'+q+' Cum Supply.html', auto_open=False)    
            fig_Cumsum_Plant.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/supply/all plant/'+q+' Cum Supply.png')
        ...
        for m in market_list:
            ...
            for j in range(0, today.month -1 ):
                fig_Cumsum_Market.add_annotation(x=bardate[j], y=df_cumulative[m+' Cum Difference'].loc[bardate].min()+0.5,
                        ...
                        #text=df_cumulative[m+' Cum Difference'].loc[bardate[j]].iloc[0],
                        showarrow=False)
            ...
            py.plot(fig_Cumsum_Market, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/supply/all market/'+m+' Cum Supply.html', auto_open=False)    
            fig_Cumsum_Market.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/supply/all market/'+m+' Cum Supply.png')
    
    def all_plant_daily(df_basin, dfsupplyMA, dfsupplyMA_eta_plant, dfihscontractsupply, date_dict, SupplyCategories):
        
        #print(df_basin)
        #print(dfsupplyMA.loc[:,'Coral South FLNG'])
        today=datetime.date.today()
        ...
        #allplant.remove('Mozambique Area 1')
        #allplant.remove('Calcasieu Pass')
        #print(df_basin[['Coral South FLNG','Coral South FLNG Desk','Coral South FLNG Difference']].loc[date_dict['current_year_start']:date_dict['today']])
        x_index=pd.date_range(date_dict['current_year_start'],date_dict['current_year_end'])
        ...
        for p in allplant:
            ...
            supply_yoy['Kpler 2021'] = dfsupplyMA.loc['2021-01-01':'2021-12-31', p].values
            supply_yoy['max']=supply_yoy[['Kpler 2017','Kpler 2018','Kpler 2019','Kpler 2020','Kpler 2021']].max(axis=1)
            supply_yoy['min']=supply_yoy[['Kpler 2017','Kpler 2018','Kpler 2019','Kpler 2020','Kpler 2021']].min(axis=1)
            #print(supply_yoy['min'])
            ...
            fig_allplant_daily.update_layout(
                        ...
                        legend=dict(x=0, y=-0.2),
                        legend_orientation="h",
                        title_text=p + ' 10 days MA, Mcm/d '+ str(today),
            ...
            py.plot(fig_allplant_daily, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/supply/all plant/'+p+' supply.html', auto_open=False)    
            fig_allplant_daily.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/supply/all plant/'+p+' supply.png')
    ...
    def Basin_Chart_demand(df_basin_demand, date_dict):
        ...
        fig_Basin.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Basin Demand, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_JKTC.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='JKC Demand, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_region.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Regional aggregated demand, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        fig_Market.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Growth Markets demand, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        for i in chart_list:
            ...
            fig.add_trace(
                    go.Scatter(
                        x=x_index,
                        y=df_basin_demand[i+' Desk'].loc[date_dict['next_year_start']:date_dict['next_year_end'][0:7]+'-31'],
                        mode="lines",
                        name='Desk view '+str(today.year+1),
                        showlegend=True,
                        line=dict(color='red', width=2, dash='dot')
            ...
            fig.update_layout(
                ...
                legend=dict(x=0, y=-0.2),
                legend_orientation="h",
                title_text=i+' , 10 days MA, Mcm/d '+ str(today),
                yaxis_title="Net Imports (Mcm/d)",
                xaxis = dict(dtick="M1"),
                hovermode='x unified',
                plot_bgcolor = 'white',
            ...
            py.plot(fig, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/'+i+'.html', auto_open=False)
            fig.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/'+i+'.png')
        
        
        
        py.plot(fig_Basin, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/Basin demand.html', auto_open=False)
        py.plot(fig_JKTC, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/JKTC demand.html', auto_open=False)
        py.plot(fig_Market, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/Market demand.html', auto_open=False)
        py.plot(fig_region, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/region demand.html', auto_open=False)
        
        fig_Basin.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/Basin demand.png')
        fig_JKTC.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/JKTC demand.png')
        fig_Market.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/Market demand.png')
        fig_region.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/region demand.png')
    ...
    def Demand_Cumulative_Chart(df_cumulative_demand, date_dict, DemandCategories):
        ...
        #print(df_cumulative_demand['EurDesk Cum'])
        #PLot Basin and Suez cumsum
        for p in BasinSuez:
            fig_Cumsum_Basin = go.Figure() 
            ...
            fig_Cumsum_Basin.add_trace(
                    go.Scatter(
                        x=x_index,
                        y=df_cumulative_demand[p+' Cum'].loc[date_dict['last_year_start']:date_dict['last_year_end']].values,
                        mode="lines",
                        name='Kpler '+str(today.year-1),
                        showlegend=True,
                        line=dict(color='#7F7F7F', width=2, dash='dash')
            ...
            py.plot(fig_Cumsum_Basin, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/demand/BasinSuez/'+p+' Cum Demand.html', auto_open=False)    
            fig_Cumsum_Basin.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/demand/BasinSuez/'+p+' Cum Demand.png')
        ...
        for m in allcountry:
            ...
            py.plot(fig_Cumsum_Market, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/demand/all market/'+m+' Cum Demand.html', auto_open=False)    
            fig_Cumsum_Market.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/demand/all market/'+m+' Cum Demand.png')
    ...
    def Region_Flex(df_basin_demand, date_dict, DemandCategories, mttomcmd):
        ...
        fig_Flex.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Eur Deskope, 10 days MA, Mcm/d '+ str(today),
            yaxis_title="Mcm/d",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        py.plot(fig_Flex, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/region flex.html', auto_open=False)
        fig_Flex.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/region flex.png')
    ...
    def NWE_cargo(df_basin_demand, df_cumulative_demand, date_dict, DemandCategories, mttomcmd):
        ...
        fig_Flex.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Eur Deskope, 10 days MA, Mt '+ str(today),
            yaxis_title="Mt",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        py.plot(fig_Flex, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/region flex mt.html', auto_open=False)
        fig_Flex.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/region flex mt.png')
        ...
        fig_Flex_cargo.update_layout(
            ...
            legend=dict(x=0, y=-0.2),
            legend_orientation="h",
            title_text='Eur Deskope, 10 days MA, cargos '+ str(today),
            yaxis_title="cargos",
            xaxis = dict(dtick="M1"),
            hovermode='x unified',
            plot_bgcolor = 'white',
        ...
        py.plot(fig_Flex_cargo, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/region flex cargo.html', auto_open=False)
        fig_Flex_cargo.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/region flex cargo.png')
        ...
        py.plot(fig_Cumsum_cargo, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/demand/BasinSuez/EurDesk Cum cargo.html', auto_open=False) 
        fig_Cumsum_cargo.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/demand/BasinSuez/EurDesk Cum cargo.png')
        ...
        fig_Cumsum_bcm.add_annotation(x=last_month, y=EurCumBcm['EurDesk Cum'].loc[last_month],
                text = str(EurCumBcm['EurDesk Cum'].loc[[last_month]].values)+' (Kpler '+str(today.year)+')',
                showarrow=True,
                arrowhead=5)
        ...
        py.plot(fig_Cumsum_bcm, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/cumulate/demand/BasinSuez/EurDesk Cum bcm.html', auto_open=False) 
        fig_Cumsum_bcm.write_image('U:/Trading - Gas/LNG/LNG website/Flow/cumulate/demand/BasinSuez/EurDesk Cum bcm.png')
    
    def desk_demand_chart(dfnetdemand, dfbasindemand, date_dict):
        
        #print(dfnetdemand)
        #desk Mcm/d to Mt
        dfbasindemandMt = dfbasindemand.copy()
        no_china_cols = [x for x in dfbasindemandMt.columns if x != 'China']
        for i in dfbasindemandMt.index:
            days=calendar.monthrange(i.year,i.month)
            #China conversion 1376
            dfbasindemandMt.loc[i,'China']=dfbasindemandMt.loc[i, 'China']/1376
            #all others 1397
            dfbasindemandMt.loc[i,no_china_cols]=dfbasindemandMt.loc[i,no_china_cols]/1397
        
        
        #Desk Demand YoY - Kpler Mt
        index = str(date_dict['today'].year) + ' - ' + str(date_dict['today'].year-1)
                    
        dfdeskdemandyoy = pd.DataFrame( index = [index], columns = ['JKTC','MEIP','LatAm','EurDesk','OtherRoW','OtherEur'])
        for i in dfdeskdemandyoy.columns:
            #print(dfbasindemandMt.loc[str(date_dict['today'].year),i+' Desk'])
            #print(dfnetdemand.loc[str(date_dict['today'].year-1),i])
            dfdeskdemandyoy.loc[index, i] = dfbasindemandMt.loc[str(date_dict['today'].year),i+' Desk'].sum() - dfnetdemand.loc[str(date_dict['today'].year-1),i].sum()
        
        dfdeskdemandyoy = dfdeskdemandyoy.astype('float').round(2)
        marker_color=['#44546A','#7030A0','#FFFF00','#00B0F0','#FF0000','#D9D9D9','#00B050']
        
        figdeskdemandyoy = go.Figure()
        for i in dfdeskdemandyoy.columns:
            figdeskdemandyoy.add_trace(go.Bar(x=dfdeskdemandyoy.index, y=dfdeskdemandyoy.loc[index, [i]],
                                              text=dfdeskdemandyoy.loc[index, i],
                                              textposition='auto',
                                              name = i,
                                              width = 0.5,
                                              marker_color = marker_color[dfdeskdemandyoy.columns.tolist().index(i)]
                                              ))
        
        figdeskdemandyoy.update_layout(barmode='relative', 
                                       title_text='Desk Demand YoY '+str(date_dict['today'].year)+' vs '+str(date_dict['today'].year-1)+' (Mt)',
                                       legend=dict(orientation="h",)
                                       )
        
        py.plot(figdeskdemandyoy, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/DeskDemandYoY.html', auto_open=False)
        figdeskdemandyoy.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/DeskDemandYoY.png')
        
        #Desk demand YoY mothly Mcm/d
        dfbasindemandmonthly = dfnetdemand.copy()
        dfbasindemandmonthly = dfbasindemandmonthly.resample('MS').sum() #Mt total month
        for day in dfbasindemandmonthly.index:#pd.date_range(start = date_dict['current_year_start'], end = date_dict['current_year_end'],freq='MS'):
            days=calendar.monthrange(day.year,day.month)
            dfbasindemandmonthly.loc[day]=dfbasindemandmonthly.loc[day]*1397/days[1]
         
        #print(dfbasindemandmonthly['JKTC'])
        
        dfbasindemandM = dfbasindemand.copy().resample('MS').mean() #Mcm/d 
        #print(dfbasindemandM['JKTC Desk'])
        index_month = pd.date_range(start = date_dict['current_year_start'], end = date_dict['current_year_end'], freq = 'MS')
                    
        dfdeskdemandyoymonthly = pd.DataFrame( index = index_month, columns = ['JKTC','MEIP','LatAm','EurDesk','OtherRoW','OtherEur'])
        for i in dfdeskdemandyoymonthly.columns:
            #print(dfbasindemandM.loc[date_dict['current_year_start']:date_dict['current_year_end'], i+' Desk'])
            #print(dfbasindemandmonthly.loc[date_dict['last_year_start']:date_dict['last_year_end'],i])
            dfdeskdemandyoymonthly[i] = dfbasindemandM.loc[date_dict['current_year_start']:date_dict['current_year_end'], i+' Desk'].values - dfbasindemandmonthly.loc[date_dict['last_year_start']:date_dict['last_year_end'],i].values
        #print(dfdeskdemandyoymonthly)
        #for day in dfdeskdemandyoymonthly.index:#pd.date_range(start = date_dict['current_year_start'], end = date_dict['current_year_end'],freq='MS'):
         #   days=calendar.monthrange(day.year,day.month)
          #  dfdeskdemandyoymonthly.loc[day]=dfdeskdemandyoymonthly.loc[day]/days[1]
                    
        dfdeskdemandyoymonthly = dfdeskdemandyoymonthly.astype('float').round().astype(int)
        dfdeskdemandyoymonthly = dfdeskdemandyoymonthly.T
        
        figdeskdemandyoymonthly = go.Figure()
        for i in dfdeskdemandyoymonthly.index:
            figdeskdemandyoymonthly.add_trace(go.Bar(x=dfdeskdemandyoymonthly.columns, y=dfdeskdemandyoymonthly.loc[i],
                                              text=dfdeskdemandyoymonthly.loc[i],
                                              textposition='auto',
                                              name = i,
                                              marker_color = marker_color[dfdeskdemandyoy.columns.tolist().index(i)]
                                              #width = 0.5
        ...
        figdeskdemandyoymonthly.update_layout(barmode='relative', 
                                       title_text='Desk Demand YoY Monthly '+str(date_dict['today'].year)+' vs Kpler '+str(date_dict['today'].year-1)+', (Mcm/d)',
                                       legend=dict(orientation="h",)
                                       )
        
        py.plot(figdeskdemandyoymonthly, filename='C:/Users/SVC-GASQuant2-Prod/YWwebsite/LNG website/Flow/daily/demand/region/DeskDemandYoYmonthly.html', auto_open=False)
        figdeskdemandyoymonthly.write_image('U:/Trading - Gas/LNG/LNG website/Flow/daily/demand/region/DeskDemandYoYmonthly.png')
    ...
    def flow_daily():
        ...
        date_dict={
               ...
               'today' : datetime.date.today(),
               'last_month': str(datetime.date(datetime.date.today().year,datetime.date.today().month,1)-datetime.timedelta(1)),#str((datetime.date.today() - relativedelta(months=1)).year)+'-'+str((datetime.date.today() - relativedelta(months=1)).month),
        ...
        dfdemand, dfsupplyplant, dfsupplycountry, dfsupplyMA_eta, dfsupplyMA_eta_plant, dfdemandMA_eta, desk_supply_plant_view, desk_supply_country_view, desk_demand_view, dfihscontractdemand,dfihscontractsupply, supply_country_list, demand_country_list, dfbasinsupply,dfbasindemand,dfcumsupply,dfcumdemand,dfnetdemand = a.full_data()
        #regional data plot
        ...
        print('\033[0;31;46m Country and Golbal has updated at: ～\033[0m' ,datetime.datetime.now() )
        ...
        a.desk_demand_chart(dfnetdemand, dfbasindemand,date_dict)
        print('\033[0;31;46m basin, plant and region flex has updated at: ～\033[0m' ,datetime.datetime.now() )
        
#FlowMA10Chart.flow_daily()
'''
